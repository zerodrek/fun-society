                        ...
                        for (let i = 0; i < availableQuestions[5].question.answers.length; i++) {
                            ...
                            function displayAnswer() {
                                ...
                                if (answeredQuestions === 6) {
                                    ...
                                    $.ajax({
                                        url: availableQuestions[0].question.gif,
                                        movie: availableQuestions[0].question.movie,
                                        tv: availableQuestions[0].question.tv,
                                        method: 'GET'
                                    }).done(function(response) {
                                        $('.gif').attr('src', url);
                                        $('.movie-info').html("<p>Rating: " + response.Rated + "</p><p> Year Released: " + response.Year + "</p><p> Plot: " + response.Plot + "</p>");
                                        /*$('.tv-info').html("<p>Rating: " + response.Rated + "</p><p> Year Released: " + response.Year + "</p><p> Plot: " + response.Summary + "</p>");*/
                                    });
                                }
                            }
